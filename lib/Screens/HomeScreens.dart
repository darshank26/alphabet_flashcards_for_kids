                        ...
                        child: Center(
                          child:  Column(
                            ...
                            children: [
                              ...
                              toggle  ?  Text("${_charNames.elementAt(index)}",
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        if (_pageController.page!.round() > 0) {
                                          ...
                                          if(check_volume)
                                            {
                                              ftts.speak(_charVoice.elementAt(index-1) + ' for ' + _alphabectNames.elementAt(index-1));
                                            }
...
*/
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        ...
                                        if(check_volume)
                                          {
                                            ftts.speak(_charVoice.elementAt(index) + ' for ' + _alphabectNames.elementAt(index));
                                          }
